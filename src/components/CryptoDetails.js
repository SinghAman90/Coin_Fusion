...
const CryptoDetails = () => {
  ...
  return ReactDOM.createPortal(
    <div
      onClick={close}
      className="fixed top-0 h-full w-full bg-gray-200 bg-opacity-50 first-letter : backdrop-blur-sm flex items-center justify-center font-nounito"
    >
      <div
        onClick={(e) => e.stopPropagation()}
        className="w-[65%] h-[90%] bg-gray-300 bg-opacity-75 rounded-lg text-white relative"
      >
        {data ? (
          <div className=" flex items-center justify-between h-full w-full p-4 ">
            <div className="flex flex-col w-[45%] h-full pr-2">
              ...
              <div className="flex w-full mt-4 justify-between">
                <HighLowIndicator currentPrice={data.market_data.current_price[currency]}
              ...
              <div className="flex w-full mt-4 justify-between">
                <div className="flex flex-col">
                  ...
                  >
                    {data.links?.homepage[0].substr(0, 30)}
                  </a>
                  <a
                    target="_blank"
                    rel="noreferrer"
                  ...
                  >
                    {data.links?.blockchain_site[0].substr(0, 30)}
                  </a>
                  {data.links.official_forum_url[0] ? (
                    ...
                    >
                      {data.links.official_forum_url[0].substr(0, 30)}
                    </a>
                  ) : null}
                </div>
                ...
                <div className="flex flex-col content-start">
                  ...
                  <div
                    className={`text-sm px-1 ml-2 my-1 font-medium flex items-center rounded uppercase bg-opacity-25 ${
