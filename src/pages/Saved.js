...
const Saved = () => {
  ...
  return (
    <>
      <div className=" w-[80%] flex flex-col mt-9 border border-gray-100 rounded">
      {
        SavedData ? 
          ( (
            ...
            font-medium border-b border-gray-100"
                ...
                hover:bg-gray-200 last:border-b-0 cursor-pointer"
                  onClick= {() => navigate_to(data.id) }
                      >
                        <td className="py-4 flex items-center upppercase">
                        ...
                        <td className="py-4 ">
                          {Number(data.high_24h).toFixed(3)}
                        </td>
                        <td className="py-4 ">{Number(data.low_24h).toFixed(3)}</td>
                      </tr>
                    );
                  })}
                </tbody>
